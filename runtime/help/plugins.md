...
plugin's website, dependencies, etc... [Here is an example `repo.json` file
from the go plugin](https://github.com/micro-editor/updated-plugins/blob/master/go-plugin/repo.json), which has the following file structure:
